...
export function HomePage({openedDate, months, openedProducts, setOpenedProducts, unopenedProducts, setUnopenedProducts, setOpenedDate, setMonths, setReplaceSoonProducts}: HomePageProps): JSX.Element{
